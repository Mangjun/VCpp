...
// 문자 배열을 비움
void clear(int array[], int& index, char& ch)
{
...
/**
* 고쳐야 할 점: 방향키가 입력됐을 때 -32와 뒤 숫자가 들어오는데 -32에서 짤려서 문자가 출력됨
*/
...
int main()
{
	...
	std::chrono::time_point<std::chrono::system_clock> time1, time2; // time1은 입력됐을 때 시간, time2는 입력이 완료된 시점에서 시간
